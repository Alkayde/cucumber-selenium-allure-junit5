...
public class LandingPageStepDefinition {
    ...
    public void user_is_on_green_kart_landing_page() {
        Assertions.assertTrue(landingPage.getTitleLandingPage().contains("GreenKart"));
    }
    ...
    public void cartPreviewIsShown() {
        Assertions.assertTrue(landingPage.getCartPreview().isDisplayed(), "Cart is not displayed");
    }
    ...
    public void cartPreviewContainsTheProduct() {
        ...
        Assertions.assertEquals(testContextSetup.cartPreviewProductName, testContextSetup.landingPageProductName, "Product name added on the landing page and product name in the cart are not equal");
    }
