...
public class OfferPageStepDefinition {
    ...
    public void validate_product_name_in_Offer_Page() {
        Assertions.assertEquals(testContextSetup.offerPageProductName, testContextSetup.landingPageProductName, "Product name on the landing page and product name on the offer page are not equal");
    }
